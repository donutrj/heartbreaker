...
# Subclasses
## Battlemaster
The battlemaster assumes the leadership position when things get tight. Naturally looking to the bigger picure, they lead by example, give orders, and execute on a plan.
### Orders
...
### One Step Ahead
Whenever the sum of your attack roll is equal to or greater than 20, perform a free [[Mechanics#Combat#Combat Maneuvers|combat maneuver]].
...
## Duelist
### Solo Artist
The duelist is trained to fight mono-e-mono. When adjacent to only one enemy, they gain [[Mechanics#Advantage|advantage]] on their attack rolls.
...
+ [[Arms & Armor#Qualities|Martial]] weapons deal an extra 2 damage with each hit.
+ [[Arms & Armor#Qualities|Light]] weapons don't reduce the damage die.
+ [[Arms & Armor#Qualities|Long]] weapons can be used indoors.
+ [[Arms & Armor#Qualities|Reach]] weapons don't impose disadvantage to hit.
+ [[Arms & Armor#Qualities|Ranged]] weapons gain +2 to hit rolls.
...
Treat [[Arms & Armor#Armor|armor's disadvantages]] as one step lower than described. e.g. light armor has no downsides, medium has light armor's and heavy armor has medium's
## Fighting Styles
### Orthodox
